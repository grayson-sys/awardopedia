...
import { ArrowLeft, Bookmark, BookmarkCheck, Share2, Mail, Copy, Check, MessageCircle } from 'lucide-react'
...
function ShareButton({ opp }) {
  ...
  function handleEmail() {
    const subject = encodeURIComponent(`Federal Contract: ${shareTitle}`)
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, color: '#6B7280', marginBottom: 4 }}>Share via</div>
            <div style={{ fontSize: 11, color: '#9CA3AF' }}>awardopedia.com</div>
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 13, color: '#78350F', margin: '0 0 10px', lineHeight: 1.6 }}>
                  This opportunity has attachments marked as <strong>Controlled</strong> on SAM.gov. These are sensitive documents that require safeguarding but aren't classified (SECRET/TOP SECRET). Common reasons include technical drawings, export-controlled items (ITAR/EAR), or Critical Safety Items.
                </p>
                <p style={{ fontSize: 13, color: '#78350F', margin: '0 0 10px', lineHeight: 1.6 }}>
                  <strong>To access controlled documents:</strong>
                </p>
                <ol style={{ fontSize: 13, color: '#78350F', margin: '0 0 10px', paddingLeft: 20, lineHeight: 1.8 }}>
                  <li>You must be a registered entity in SAM.gov with an active CAGE code</li>
                  <li>Click "Request Access" on the SAM.gov opportunity page</li>
                  <li>Demonstrate legitimate "need to know" (you're considering bidding)</li>
                  <li>For ITAR items, you may need to verify U.S. person/entity status</li>
                </ol>
                <a
                  href={opp.sam_url || `https://sam.gov/opp/${opp.notice_id}/view`}
                  target="_blank"

      ...
      <div className="container" style={{
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-2)" }}>
            <Link href="/awards" style={{ color: "var(--color-white)", opacity: 0.7, fontSize: "var(--font-size-sm)" }}>Awards</Link>
            <Link href="/agencies" style={{ color: "var(--color-white)", opacity: 0.7, fontSize: "var(--font-size-sm)" }}>Agencies</Link>
            <Link href="/expiring" style={{ color: "var(--color-white)", opacity: 0.7, fontSize: "var(--font-size-sm)" }}>Expiring Contracts</Link>
            <Link href="/about" style={{ color: "var(--color-white)", opacity: 0.7, fontSize: "var(--font-size-sm)" }}>About</Link>
          </div>
        </div>
        <div>
          <h4 style={{ fontSize: "var(--font-size-sm)", marginBottom: "var(--space-3)", fontWeight: "var(--font-weight-medium)" }}>
